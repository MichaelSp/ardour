...
CCurl::setup_certificate_paths ()
{
	...
	if (Glib::file_test ("/etc/pki/tls/certs/ca-bundle.crt", Glib::FileTest::IS_REGULAR)) {
		// Fedora / RHEL, Arch
		ca_info = "/etc/pki/tls/certs/ca-bundle.crt";
	} else if (Glib::file_test ("/etc/ssl/certs/ca-certificates.crt", Glib::FileTest::IS_REGULAR)) {
		// Debian and derivatives
		ca_info = "/etc/ssl/certs/ca-certificates.crt";
	} else if (Glib::file_test ("/etc/pki/tls/cert.pem", Glib::FileTest::IS_REGULAR)) {
